/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 45d101a8a5e9f83902a113c34623949f)
// Runtime types generated with workerd@1.20260826.1 2026-08-01 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	BUNDLES: R2Bucket;
	NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
	DB: D1Database;
	SCENARIO_LIMITER: RateLimit;
	ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_INC_CACHE_R2_PREFIX">> {}
}
